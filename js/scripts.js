                        ...
                        <div class="catalogo-container">
                            ...
                            <div id="tiradasContainer" class="catalogo">
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Cómo amo y me amas.<br>Cómo hago daño y me defiendo.<br>Cómo el otro daña y se defiende.<br>Quién eres y hacia dónde van.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Debilidad actual.<br>Qué me ayudará a superar esto.<br>Qué nueva dirección puedo tomar.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Qué causa problemas.<br>Nuestras opciones.<br>Qué necesitamos expresar.<br>Hacia dónde vamos en adelante.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Pasado.<br>Presente.<br>Futuro.<br>Observación de plazo de 12 meses.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>El objetivo.<br>Las obstrucciones.<br>Los sacrificios a hacerse.<br>Qué le ayudará.<br>Cómo seguirá.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    <h2>La Cruz</h2>
                                    <div class="info">
                                        <p>De qué se trata.<br>Lo que no debes hacer.<br>Lo que sí debes hacer.<br>Lo que te llevará a conseguir lo que quieres.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Usted.<br>Lo que debe vivir y aprender.<br>Cómo se manifiesta en su vida.<br>Consejo de la divinidad.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    <h2>Los Secretos</h2>
                                    <div class="info">
                                        <p>Los deseos y los sentimientos secretos.<br>Los miedos y odios secretos.<br>El amor y fantasías secretos.<br>Vulnerabilidad y poder secretos.<br>El mayor secreto.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Autoconocimiento.<br>Lo que no sabes de ti.<br>Lo que los demás sí saben.<br>Cómo llegas a valorarte.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    <h2>El Compás</h2>
                                    <div class="info">
                                        <p>De qué se trata.<br>Así comienza.<br>Las reacciones.<br>En qué desemboca.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Lo que siento/Lo que siente.<br>Lo que creo/Lo que cree.<br>Lo que quieres/Lo que el otro quiere.<br>Resultado.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>El objetivo en el amor.<br>Lo que puede ofrecer.<br>El punto central de todo.<br>Lo que puedo hacer para que mi relación funcione.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Situación actual.<br>Lo que ve, percibe y siente.<br>Cómo actúa.<br>Consejo.</p>
                                    </div>
                                </div>
                                ...
                                <div class="tirada tirada-bonita" style="background-image: url('img/deb.jpg');">
                                    ...
                                    <div class="info">
                                        <p>Tu problema.<br>Cómo lo afrontas.<br>La solución.</p>
                                    </div>
                                </div>
                            </div>
                        </div>`;
