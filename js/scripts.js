function cargarContenido(seccion) {
    ...
    switch (seccion) {
        ...
        case 'tiradas':
            ...
            <!-- Banner: Tirada de Tarot Gratis -->
            <div style="grid-column: 1 / -1; margin-top: 25px; padding: 26px 20px; background: rgba(58, 42, 72, 0.88); border-radius: 14px; border: 2px solid #8b7a9e; color: #f5f0e6; text-align: center; box-shadow: 0 6px 20px rgba(0, 0, 0, 0.4);">
